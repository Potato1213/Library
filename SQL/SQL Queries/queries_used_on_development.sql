...
insert into tblUsers values('Avila','Avila@gmail.com','123456',CURRENT_TIMESTAMP ,1,'super_admin');
select * from tblUsers
update tblUsers set isActive = 1 where id = 1
Exec _Login 'root@lms.com','123456'
insert into tblUsers values('Mijares','Mijares@lms.com','123',CURRENT_TIMESTAMP ,1,'admin')
